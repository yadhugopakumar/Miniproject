...
//     // Listens to changes in medicinesBox
...
//             children: [
//               // Progress bar will be updated below
...
//                         medicine: med,
//                         time: time,
//                         dosage: med.dosage, // Assuming 'dosage' is a property of 'Medicine'
//                         taken: isDoseTaken,
//                       ));
//                     }
//                   }
...
//                           context),
//                       taken: sched.taken,
//                       backgroundGreen: backgroundGreen, onTap: () async {
...
//                           date: now,
//                           time: sched.time,
//                           medicineName: "${sched.medicine.name}@${sched.time}",
//                           status: 'taken',
//                         ),
//                       );
...
//                       setState(
//                           () {}); // This triggers UI and progress bar update
//                     }
//                   });
//                 },
                  ...
                  return _scheduleTile(
                    ...
                    onTap: () async {
                      ...
                      if (confirm == true) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Marked as taken!',style:TextStyle(color: Colors.black),),
                            behavior: SnackBarBehavior.floating,
