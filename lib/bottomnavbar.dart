...
class _BottomnavbarState extends State<Bottomnavbar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _selectedIndex !=1 ? Padding(
      ...
      bottomNavigationBar:_selectedIndex!=1 ? Padding(
      ...
      child: FractionallySizedBox(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            color: Color.fromARGB(255, 219, 222, 223),
          ),
          child: Builder(
            builder: (innerContext) => ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  innerContext,
                  MaterialPageRoute(builder: (context) => Profilepage(name: title.data!)),
                );
              },
            ),
          ),
