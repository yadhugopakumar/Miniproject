...
//         position: 'top-end',
//         icon: 'success',
//         title: 'Child user updated successfully',
//         showConfirmButton: false,
//         timer: 1000,
//       });

//       setIsEditing(false);
//       // Optionally refetch child data or update local state here
...
//           <h2 className="text-2xl font-semibold mb-4">{child.username}{childData?childData:""}</h2>
//           <p className="mb-2">
//             <strong>Age:</strong> {child.age}
//           </p>
//           <p className="mb-2">
//             <strong>Email:</strong> {child.email || "N/A"}
//           </p>
//           <p className="mb-2">
...
//               <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 rounded bg-gray-800 hover:bg-gray-600">
//                 Cancel
//               </button>
//               <button type="submit" className="px-4 py-2 rounded bg-yellow-500 hover:bg-yellow-600 text-white">
//                 Save
//               </button>
//             </div>
